...
public class Util extends BasePage
{
    ...
    public void takeSnapShot(String screenShotName)//Creating method to get screen shot
    {
        ...
        try {
            ...
            FileHandler.copy(srcFile, new File("src\\test\\ScreenShot\\" + screenShotName + ".jpg"));
            // another way to use screenshot
            // FileHandler.copy(srcFile, new File("src\\Screenshot" + screenShotName + ".jpg"));
           // FileUtils.copyFile(srcFile, new File("src\\test\\ScreenShot\\" + screenShotName + ".jpg"));
